    ...
    matchups: [
        {
            ...
            entries: [
                ...
                { opponent: 'Vulcan Stabber', verdict: 'even', advice: 'Point-range contest. Drones versus Vulcans — do not greed.' },
                { opponent: 'HAM Caracal Navy Issue', verdict: 'favoured', advice: 'They want scramble. Deny the close.' },
                { opponent: 'RLML Osprey Navy Issue', verdict: 'unfavoured', advice: 'Missile kite clips you if they hold band. Leave early.' },
                { opponent: 'Blaster Exequror Navy Issue', verdict: 'bail', advice: 'They catch you. Leave before the ram lands.' },
                { opponent: 'Armor RLML Scythe Fleet Issue', verdict: 'unfavoured', advice: 'Low-commit catcher with speed. Bail early.' },
        ...
        },
        {
            ...
            entries: [
                ...
                { opponent: 'Blaster Exequror Navy Issue', verdict: 'favoured', advice: 'Establish control early and grind. Neutrons hurt if you botch the open.' },
                { opponent: 'Dual Prop Stabber Fleet Issue', verdict: 'even', advice: 'Even trade. Respect their dual-prop leave.' },
                { opponent: 'Dual Prop Scythe Fleet Issue', verdict: 'even', advice: 'Even. Respect XLASB and AB out.' },
                { opponent: 'Dual Rep Vexor Navy Issue', verdict: 'bail', advice: 'Do not take this for fun. Warp.' },
                { opponent: 'HAM Caracal Navy Issue', verdict: 'bail', advice: 'Rage buffer deletes you. Warp.' },
                { opponent: '2X Neut HAM Osprey Navy Issue', verdict: 'bail', advice: 'Neuts plus HAM — you lose hard. Warp.' },
            ],
        },
    ],
}
    ...
    matchups: [
        {
            ...
            entries: [
                { opponent: 'Blaster Exequror Navy Issue', load: 'Conflag', verdict: 'even', advice: 'Even buffer race. High ground and heat decide it.' },
                ...
                { opponent: 'Dual Prop Scythe Fleet Issue', load: 'Conflag', verdict: 'favoured', advice: 'Punish the punch-in before they AB out.' },
                { opponent: 'Brawl Arbitrator', load: 'Conflag', verdict: 'unfavoured', advice: 'Neuts and drones eat polarized opens. Do not ego this.' },
                { opponent: 'Dual Prop Stabber Fleet Issue', load: 'Conflag', verdict: 'unfavoured', advice: 'They get under guns and speed-tank. Leave if the race turns.' },
            ],
        },
        {
            title: 'Pulse Augoror Navy Issue',
            ...
            entries: [
                ...
                { opponent: 'Armor RLML Scythe Fleet Issue', load: 'Scorch', verdict: 'favoured', advice: 'Hold band and pressure — you are favoured into this clipper.' },
    ...
    matchups: [
        {
            ...
            entries: [
                ...
                { opponent: 'RLML Osprey Navy Issue', load: 'Scorch', verdict: 'favoured', advice: 'Navy mid-band owns this kite — hold band first.' },
    ...
    matchups: [
        {
            ...
            entries: [
                ...
                { opponent: 'Brawl Arbitrator', load: 'Rage', verdict: 'favoured', advice: 'Hard win — buffer and apply delete the T1 control fit.' },
    ...
    matchups: [
        {
            ...
            entries: [
                ...
                { opponent: 'Brawl Arbitrator', load: 'Rage', verdict: 'favoured', advice: 'Hard win — cap them, then grind.' },
                { opponent: 'Dual Prop Scythe Fleet Issue', load: 'Rage', verdict: 'favoured', advice: 'Equal-to-favoured — pick the trade and finish before they AB out.' },
        ...
        },
        {
            ...
            entries: [
                { opponent: 'Long Point Arbitrator', load: 'Fury', verdict: 'favoured', advice: 'Clip the T1 drone kite if you hold point.' },
                { opponent: 'Vulcan Stabber', load: 'Fury', verdict: 'favoured', advice: 'Favoured into T1 half-kites — hold band and apply.' },
                ...
                { opponent: 'Pulse Augoror Navy Issue', load: 'Fury', verdict: 'unfavoured', advice: 'Navy mid-band with neuts. Decline fair trades.' },
                { opponent: 'Kite Omen Navy Issue', load: 'Fury', verdict: 'unfavoured', advice: 'Same job, better projection fight for them.' },
                { opponent: '250mm Rail Exequror Navy Issue', load: 'Fury', verdict: 'unfavoured', advice: 'Mid-band rails pressure you. Leave if they own band.' },
    ...
    matchups: [
        {
            ...
            entries: [
                { opponent: 'Polarized Augoror Navy Issue', load: 'Void', verdict: 'even', advice: 'Even buffer race. High ground and heat decide it.' },
                ...
                { opponent: 'Brawl Arbitrator', load: 'Void', verdict: 'unfavoured', advice: 'Their control fit eats you if neuts stick. Do not ego.' },
    ...
    matchups: [
        {
            ...
            entries: [
                ...
                { opponent: '2X Neut HAM Osprey Navy Issue', load: 'Hail', verdict: 'unfavoured', advice: 'Equal-to-unfavoured — their neuts tip the trade. Leave early.' },
        ...
        },
        {
            ...
            entries: [
                ...
                { opponent: 'Long Point Arbitrator', load: 'Fury', verdict: 'favoured', advice: 'Favoured into T1 kite — low-commit pressure with speed.' },
                { opponent: 'Vulcan Stabber', load: 'Fury', verdict: 'favoured', advice: 'Favoured into T1 — projection and speed should carry.' },
                ...
                { opponent: 'Pulse Augoror Navy Issue', load: 'Fury', verdict: 'unfavoured', advice: 'Their mid-band and neuts favour them. Leave early.' },
    ...
    matchups: [
        ...
        },
        {
            ...
            entries: [
                ...
                { opponent: 'Long Point Arbitrator', load: 'Barrage', verdict: 'even', advice: 'Point-range contest. Drones versus Vulcans — even.' },
                ...
                { opponent: 'RLML Osprey Navy Issue', load: 'Barrage', verdict: 'unfavoured', advice: 'Fatter kite with XLASB — they are favoured into T1. Decline fair trades.' },
            ],
        },
    ],
}
    ...
    matchups: [
        {
            ...
            entries: [
                ...
                { opponent: 'Brawl Arbitrator', load: 'Hail', verdict: 'even', advice: 'Even trade into T1 control — respect neuts and drones.' },
