...
export const ui = {
    en: {
        ...
        'ops_contract_metrics': 'Stock and completion metrics',
        'ops_contract_metric_stock': 'Stock',
        'ops_contract_metric_viable': 'Viable',
        'ops_contract_metric_stock_tip': 'Outstanding contracts versus the configured target at this location.',
        'ops_contract_metric_viable_tip': 'Outstanding contracts priced within 20% of the fitted EFT Forge baseline (fits under 250k ISK always count).',
        'ops_contract_metric_1d_tip': 'Contracts finished at this location in the last 1 day.',
        'ops_contract_metric_3d_tip': 'Contracts finished at this location in the last 3 days.',
        ...
        'ops_contract_readiness_empty': 'Empty',
        'ops_contract_readiness_thin': 'Thin',
