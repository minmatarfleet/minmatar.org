...
export const ui = {
    en: {
        ...
        'industry.orders.planner.leading_text': 'Plan this order item from start to finish. Select a location, configure your settings, and receive a shopping list and full price breakdown of the job.',
        'industry.orders.planner.meta_description': 'Plan what to buy and manufacture for alliance industry orders, with location taxes, structure bonuses, and compressed ore shopping lists.',
        ...
        'industry.orders.planner.invalid_params': 'Invalid order or item.',
        ...
        'industry.orders.planner.system_cost_bonus_tip': 'Discount or surcharge on job install cost from Faction Warfare infrastructure.',
        'industry.orders.planner.facility_tax': 'Facility tax',
        'industry.orders.planner.facility_tax_tip': 'Tax charged by the structure when you install an industry job.',
        'industry.orders.planner.scc_surcharge': 'SCC surcharge',
        'industry.orders.planner.scc_surcharge_tip': 'Game-wide Science and Commerce Commission surcharge on industry job install cost.',
        ...
        'industry.orders.planner.total_cost_tip': 'Full cost breakdown for this plan, including alliance freight when a hub route matches.',
