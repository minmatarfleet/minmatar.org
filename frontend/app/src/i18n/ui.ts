...
export const ui = {
    en: {
        ...
        'alliance.health.leading_text': 'Who’s been active, who’s gone quiet, trial and leave hygiene, how the corps look, and whether new joins stick around. Activity MAP excludes Discord voice; trial and leave lists include it.',
        'alliance.health.updated': 'Updated {when}',
        'alliance.health.summary.aria': 'Alliance activity and roster summary',
        'alliance.health.summary.title': 'Overview',
        'alliance.health.summary.caption': 'Where we stand on the pilot goal, quiet members, and trial/leave actions.',
        ...
        'alliance.health.monthly.caption': 'A summary of our various member metrics over time.',
        ...
        'alliance.health.series.solo': 'Solo / small gang',
        'alliance.health.series.supply': 'Supply',
        'alliance.health.mix.title': 'Alliance Member Activities',
        'alliance.health.mix.caption': 'What our members are participating in. Voice is not in this mix.',
        'alliance.health.mix.aria': 'Alliance member activities chart',
        'alliance.health.mix.fleets': 'Fleets',
        'alliance.health.mix.small_gang': 'Small gang',
        'alliance.health.mix.solo': 'Solo',
        'alliance.health.mix.supply': 'Supply',
        'alliance.health.mix.people': 'People',
        'alliance.health.attention.title': 'At Risk',
        'alliance.health.attention.caption': 'Still in corp, not on leave. Quiet on MAP signals (fleets, kills, supply) — Discord voice does not count here.',
        'alliance.health.attention.aria': 'Pilots at risk',
        'alliance.health.attention.empty': 'Nobody in this list.',
        'alliance.health.bucket.fading': 'Fading',
        'alliance.health.bucket.dark': 'Dark',
        'alliance.health.bucket.seasonal': 'Seasonal',
        'alliance.health.trials.title': 'Trials',
        'alliance.health.trials.caption': 'Alliance community status. Approve needs participation, activity in the last 30 days, and ≥60 days in alliance. Status is not changed here — upload CSVs in admin after review.',
        ...
        'alliance.health.leave.caption': 'Active members under ~1 fleet per month. Away vs OPSEC. Directors and chiefs are exempt. Upload recommended rows in admin after review.',
        'alliance.health.leave.aria': 'On leave recommendations',
        'alliance.health.leave.empty': 'Nobody recommended for leave.',
        'alliance.health.leave.kept_exempt': '{kept} kept · {exempt} exempt (not listed)',
        'alliance.health.corps.title': 'By corporation',
        'alliance.health.corps.caption': 'Activity and growth for each corp over the last 90 days.',
