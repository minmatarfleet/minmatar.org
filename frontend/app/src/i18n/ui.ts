...
export const ui = {
    en: {
        ...
        'add_primary_pilot_dialog_required_text': 'The requested action requires you to add a primary character. Select \'Yes\' to add one and complete the main pilot setup process outside of our site. Once it is successfully completed, we will return you to our platform. The following scopes will be requested:',
        'error': 'Error',
