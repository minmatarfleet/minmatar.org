...
export const ui = {
    en: {
        ...
        'group_available': 'Team available',
        'group_logo': 'Team logo',
        'view_group_description': 'View team description',
        'join': 'Join',
        ...
        'join_request_dialog_title': 'Team join request',
        ...
        'no_groups_owned': 'No owned teams found. Try contacting with a platform admin to in quire about teams ownership.',
    },
} as const;