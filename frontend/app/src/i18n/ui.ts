...
export const ui = {
    en: {
        ...
        'notification_preferences_description': 'Choose how you want to hear about industry orders and other features. Enable browser push above to receive web notifications on this device.',
        'notification_channel_web': 'Web push',
        'notification_channel_discord': 'Discord DM',
        'notification_channel_eve_mail': 'Eve mail',
        'notification_topic_subscribe': 'Subscribe to this topic (audience)',
