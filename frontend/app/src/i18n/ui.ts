...
export const ui = {
    en: {
        ...
        'industry.loyalty.offers.metrics.avg_isk_lp': 'Average ISK/LP',
        'industry.loyalty.offers.metrics.avg_isk_lp_info':
            'Volume-weighted average conversion for the selected price side (buy, sell, or 7d average) across filtered offers. Weights each offer by its weekly LP-equivalent market volume. Does not include sales tax or freight.',
