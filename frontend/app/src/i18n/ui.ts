...
export const ui = {
    en: {
        ...
        'industry.leading_text': 'Coordination is key in evolving the local industry. Whenever there is an order there are opportunities by taking part in the manufacturing process. As a Minmatar industrialist this will be your ideal starting point.',
        'industry.meta_description': 'Inspect the alliance war effort and find opportunities to colaborate.',
        'industry.description': 'Browse manufacturing orders and find which components and materials are required.',
        'page_finder.industry.description': 'Industry landing page.',

        'industry.orders.page_title': 'Orders',
        'industry.orders.leading_text': 'Start diving from a wider view into our alliance needs then transverse down into the pieces that makes the whole thing happen. Keep an eye on your orders by tracking their status - soon.',
        'industry.orders.meta_description': 'List of alliance manufacturing orders and bill of materials.',
        'page_finder.orders.description': 'List of industry orders and materials.',

        'industry.products.page_title': 'Products',
        'industry.products.leading_text': 'Looking how contribute and optimize our war effort? Start checking all products needs, their current production strategy and help us growing by becoming part of our local industry.',
        'industry.products.meta_description': 'List of products involved in the manufacturing of player orders.',
        'page_finder.products.description': 'List of products requirements for orders.',
