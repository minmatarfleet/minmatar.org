...
export const ui = {
    en: {
        ...
        'ops_health_critical_gaps': '{count} viability gaps',
        ...
        'ops_health_history': 'Health over time',
        'ops_health_history_empty': 'Snapshots appear after the next market sync.',
        'ops_health_history_overall': 'Overall',
        'ops_health_history_coverage': 'Coverage',
        'ops_health_history_viability': 'Viability',
        'ops_health_history_contracts': 'Contracts',
        'ops_health_history_problems': '{contracts} contracts · {gaps} gaps',
        'ops_volume_7d': 'Volume (7d)',
        'ops_volume_total_units': '{units} units inferred',
        'ops_volume_empty': 'No inferred sales yet for this location.',
        'ops_volume_mover': '{name} — {units}',
