...
export const ui = {
    en: {
        ...
        'primary_fittings_descriptions': 'FLEET pilots mainly',
        'secondary _fittings_descriptions': 'L3ARN pilots mainly',
        'support_fittings_descriptions': 'FLEET pilots mainly',
        'ship': 'Ship',
        'ships': 'Ships',
        ...
        'faction_warfare_description': 'These doctrines are optimized for faction warfare operations, designed for small to medium scale engagements in low-sec space.',
        'nullsec': 'Nullsec',
        'nullsec_description': 'These doctrines are designed for null-sec operations, typically featuring stronger tank and more specialized roles for large-scale fleet engagements.',
