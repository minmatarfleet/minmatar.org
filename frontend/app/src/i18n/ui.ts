...
export const ui = {
    en: {
        ...
        'buyback.appraisal.jita_note': 'Jita buy is the Forge market-history average (our price guide). Ore is priced from refined minerals (no single Jita price on the ore itself). Rate is the share of that baseline we pay: full for supply-chain demand, lower for surplus.',
        'buyback.appraisal.again': 'New paste',

        'buyback.faq.title': 'FAQ',
        'buyback.faq.1_title': 'How do I price my contract?',
        'buyback.faq.1_text': 'Paste your items on this page. We pay full Jita buy for materials our industry supply chain is importing for recent orders, and a lower surplus rate for other accepted ore and PI (ore is still refined at the listed %). Use the offer total on the in-game contract.',
