...
export const ui = {
    en: {
        ...
        'lost_my_ship': 'In which kind of fleet you lost your ship?',
        'strategic_fc': 'Strategic Fleet',
        'skirmish_fc_subcapital': 'Skirmish',
        'skirmish_fc_carriers': 'Skirmish',
        'view_killmails': 'View killmails',
        'killmail_fleet_selection_required': 'Select above the fleet type you lost your ship in. If not listed your lost is not eligible for SRP.',
        'carriers_skirmish_hint': '⚠️ Skirmish fleets are limited to 2 Carriers and 1 FAX.',
        'overview': 'Overview',
        'source': 'Source',
