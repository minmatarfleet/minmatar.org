...
export const ui = {
    en: {
        ...
        'buyback.meta_description': 'Sell compressed highsec ore and PI to Minmatar Extraction Company. Paste for an instant offer, then private item-exchange at Amo.',
        ...
        'buyback.form.paste_tip': 'Copy items from Inventory or Assets (Ctrl+A, Ctrl+C) and paste below. Full rate for supply-chain demand materials; surplus accepted items at a lower share. Ore is priced from refine yield (including stacks under 100).',
        ...
        'buyback.faq.2_title': 'How long until I get paid?',
        'buyback.faq.2_text': 'Usually within a day. Big hauls (15b+) — [check Discord first]({discord_url}).',
        'buyback.faq.2_text_plain': 'Usually within a day. Big hauls (15b+) — check Discord first.',
        'buyback.faq.3_title': 'Where do I contract?',
        'buyback.faq.3_text': 'Private item exchange to Minmatar Extraction Company at Amo – Minmatar Ore Reprocessing. Minerals only if already in Amo or Auner.',
        ...
        'page_finder.buyback.description': 'Alliance buyback through Minmatar Extraction Company.',
