...
export const ui = {
    en: {
        ...
        'guides.seo.index.meta_title': 'EVE Online Guides | Faction Warfare, Abyss & Fleet | {site}',
        'guides.seo.index.meta_description': 'Minmatar Fleet Alliance guides for EVE Online: faction warfare basics, plexing, navy destroyer metagame, abyssal deadspace fits, L5 missions, and fleet tools.',
        'guides.seo.index.keywords': 'EVE Online guides, faction warfare guide, faction warfare basics, abyssal deadspace, navy destroyer, militia fleet, Minmatar FW',
        'guides.seo.navy-destroyer-metagame.meta_title': 'Navy Destroyer Metagame | EVE Online FW Guide | {site}',
        'guides.seo.navy-destroyer-metagame.meta_description': 'Furl0w\'s EVE Online navy destroyer metagame guide: Catalyst, Coercer, Thrasher, and Cormorant Navy Issue fits, 1v1 matchup charts, and solo FW plex tactics.',
        'guides.seo.navy-destroyer-metagame.keywords': 'navy destroyer metagame, faction warfare, Catalyst Navy Issue, Thrasher Fleet Issue, 1v1 pvp, matchup chart',
        'guides.seo.faction-warfare-basics.meta_title': 'Faction Warfare Basics | EVE Online FW Guide | {site}',
        'guides.seo.faction-warfare-basics.meta_description': 'Learn EVE Online faction warfare basics: warzone map, frontlines, complexes, advantage, battlefields, and loyalty points for Minmatar militia pilots.',
        'guides.seo.faction-warfare-basics.keywords': 'faction warfare basics, FW guide, warzone map, frontlines, complexes, loyalty points, Minmatar militia',
        'guides.seo.faction-warfare-advantage.meta_title': 'Faction Warfare Advantage Guide | EVE Online FW | {site}',
        'guides.seo.faction-warfare-advantage.meta_description': 'How EVE Online faction warfare advantage works: build net advantage with plexing, rendezvous sites, battlefields, and propaganda structures to flip systems faster.',
        'guides.seo.faction-warfare-advantage.keywords': 'faction warfare advantage, FW advantage, victory points, ihub, rendezvous, propaganda broadcast',
        'guides.seo.faction-warfare-plexing.meta_title': 'Faction Warfare Complexes Guide | FW Plexing | {site}',
        'guides.seo.faction-warfare-plexing.meta_description': 'EVE Online FW plexing guide: landing mechanics, Cradle of War sites, LP payout tables, and victory points by complex size.',
        'guides.seo.faction-warfare-plexing.keywords': 'faction warfare plexing, FW complexes, Cradle of War, LP payouts, victory points, Moderate NVY-3, militia',
        'guides.seo.rendezvous-wolf.meta_title': 'Rendezvous Wolf Guide | EVE Online FW PvE | {site}',
        'guides.seo.rendezvous-wolf.meta_description': 'Run Amarr Rendezvous sites in EVE Online faction warfare with a PvE-fit autocannon Wolf assault frigate. FW advantage farming guide.',
        'guides.seo.rendezvous-wolf.keywords': 'rendezvous site, autocannon wolf, faction warfare pve, assault frigate, FW advantage',
        ...
        'ships.navy_destroyer_metagame.meta_description': 'Furl0w\'s EVE Online navy destroyer metagame guide: Catalyst, Coercer, Thrasher, and Cormorant Navy Issue fits, 1v1 matchup charts, and solo FW plex tactics.',
