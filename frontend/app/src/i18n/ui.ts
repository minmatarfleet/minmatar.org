...
export const ui = {
    en: {
        ...
        'guides.seo.index.meta_description': 'Free EVE Online guides from Minmatar Fleet: faction warfare basics, plexing, advantage, navy destroyer PvP, abyssal fits, L5 missions, and fleet tools.',
        'guides.seo.index.keywords': 'EVE Online guides, faction warfare guide, FW plexing, FW advantage, navy destroyer, abyssal deadspace, militia fleet, Minmatar Fleet',
        'guides.seo.navy-destroyer-metagame.meta_title': 'Destroyer Guide | EVE Online FW Guide | {site}',
        'guides.seo.navy-destroyer-metagame.meta_description': 'Faction warfare destroyer guide: navy hulls plus Algos, Thrasher, Coercer, and Dragoon—fits, matchup charts, and solo plex tactics.',
        'guides.seo.navy-destroyer-metagame.keywords': 'destroyer guide, faction warfare, Catalyst Navy Issue, Thrasher Fleet Issue, Algos, Coercer, Dragoon, 1v1 pvp, matchup chart',
        'guides.seo.navy-frigate-guide.meta_title': 'Frigate Guide | EVE Online FW Guide | {site}',
        'guides.seo.navy-frigate-guide.meta_description': 'Comprehensive frigate guide for faction warfare.',
        'guides.seo.navy-frigate-guide.keywords': 'navy frigate, T1 frigate, faction warfare, Hookbill, Comet, Slicer, Firetail, Vigil Fleet Issue, Rifter, Tristan, Breacher, Scout complex, Minmatar Fleet',
        ...
        'ships.navy_destroyer_metagame.page_title': 'Destroyer Guide',
        'ships.navy_destroyer_metagame.leading_text': 'Faction warfare destroyer guide.',
        'ships.navy_destroyer_metagame.meta_title': 'Destroyer Guide | Faction Warfare Guide | {site}',
        'ships.navy_destroyer_metagame.meta_description': 'Faction warfare destroyer guide: navy hulls plus Algos, Thrasher, Coercer, and Dragoon—fits, matchup charts, and solo plex tactics.',
        'page_finder.ships.navy_destroyer_metagame.description': 'Faction warfare destroyer guide with navy and T1 fits, matchup charts, and 1v1 tactics.',
        'ships.navy_frigate_guide.page_title': 'Frigate Guide',
        'ships.navy_frigate_guide.leading_text': 'Comprehensive frigate guide for faction warfare.',
        'ships.navy_frigate_guide.meta_title': 'Frigate Guide | Faction Warfare Guide | {site}',
        'ships.navy_frigate_guide.meta_description': 'Comprehensive frigate guide for faction warfare.',
        'page_finder.ships.navy_frigate_guide.description': 'Comprehensive frigate guide for faction warfare.',
        ...
        'visit': 'Visit',
        'destroyer_guide_title': 'Destroyer Guide',
