...
export const ui = {
    en: {
        ...
        'add_primary_pilot_dialog_title': 'Set main pilot disclaimer',
        'add_primary_pilot_dialog_text': 'You will undergo the main pilot linking process outside of our site. Once it is successfully completed, we will return you to our platform.',
        'remove_pilot_dialog_title': 'Remove pilot',
        'remove_pilot_dialog_text': 'Proceed with unlinking the following pilot from the account?',
        ...
        'delete_character_error': 'An error occurred while unlinking the pilot.',
        'yes': 'Yes',
        'no': 'No',
        'requesting_concord': 'Requesting for CONCORD approval',
        'add_primary_pilot': 'Set main pilot',
        'change_primary_pilot': 'Change main pilot',
