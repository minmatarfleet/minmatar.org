...
export const ui = {
    en: {
        ...
        'ships.srp.page_title': 'Ship Replacement Program',
        'ships.srp.leading_text': 'Designed to minimize downtime, SRP rewards participation in fleet operations by covering a portion or all of the lost ship’s cost.',
        'page_finder.ships.srp.description': 'Ship Replacement Program landing page.',
        ...
        'subcapitals_program_description': 'Our expectation with subcapitals is that alliance will cover 50-100% of your costs.',
        ...
        'dreads_program_description': 'Our expectation with dreadnoughts is that alliance will cover 25-33% of your costs, insurance 10-15%, with the pilot and their corporation covering the remaining costs.',
        'other_dreadnought': 'Other Dreadnought',
        'carriers_program': 'Carriers Program',
        'carriers_program_description': 'Our expectation with carriers is that alliance will cover 33-50% of your costs, insurance 10-15%, with the pilot and their corporation covering the remaining costs.',
        ...
        'overview': 'Overview',
        'source': 'Source',
        'overview_description': 'More on how Minmatar Fleet Alliance avoids taxes, burnout, and traditional SRP models to prioritize corporation autonomy and sustainable income.',
        'source_description': 'More on where alliance funding comes from and how it supports fleet incentives and partial ship subsidies.',
        'analyze': 'Analyze',
        ...
        'add_killmail_intro_text': 'Welcome to our **{program} Ship Replacement Program**. Let’s start analyzing you killmail for eligibility.',
        ...
        'approved_last_90_days': 'Approval amount in the last 90 days.',
        'rejected_last_90_days': 'Rejected amount in the last 90 days.',
