...
export const ui = {
    en: {
        ...
        'combat_log_file_text': 'e.g., from HOME\\Documents\\EVE\\logs\\Gamelogs',
        'submit': 'Submit',
        ...
        'srp_no_fleet_submit_dialog_text': 'Add the killmail link to submit your non-fleet SRP.\n\n⚠️ Non-fleet SRP requests are rarely approved and will only be considered under exceptional circumstances. Additional details may be included in the comment field to support your request.',
