...
export const ui = {
    en: {
        ...
        'tribes.list.page_title': 'Tribes',
        'tribes.list.leading_text': 'Tribes are focused communities within Minmatar Fleet built around a shared purpose — from capital warfare to industry and logistics. Each tribe has dedicated sub-groups you can apply to join. Your application will be reviewed by the tribe\'s chief or elders.',
        'tribes.list.meta_description': 'Discover the tribes of Minmatar Fleet Alliance — specialized communities with clear leadership, trackable output, and a place for every pilot.',
        'tribes.list.groups': 'groups',
        'tribes.list.members': 'members',
        ...
        'tribes.detail.apply_confirm_text': 'Your application will be reviewed by the group chief or elders. You\'ll be contacted via Discord.',
