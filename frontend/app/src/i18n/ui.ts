...
export const ui = {
    en: {
        ...
        'tribes.leading_text': 'Tribes are focused communities within Minmatar Fleet built around a shared purpose — from capital warfare to industry and logistics. Each tribe has dedicated sub-groups you can apply to join. Your application will be reviewed by the tribe\'s chief or elders.',
        ...
        'tribes.detail.apply_confirm_text': '⚠️ Your application will be reviewed by the group chief or elders. You’ll be contacted via Discord.',
        ...
        'tribes.detail.role_elder': 'Elder',
