...
Bookmarks are accessed using the `Locations` window (in the `Personal` section of the Neocom).

Within the Locations window, the first "folder" will be for locations in your current system. You can detach this with `Open in Window` and keep it separate in your standard window layout.
...
When you create a shared folder you need to select `access control lists` to specify who can use or manage the bookmarks in the folder. Note that the ACL can be modified after the folder is created. As an alternative to the ACL you can also select your own corporation.
...
- [https://www.youtube.com/watch?v=STOFYt-GJXk](https://www.youtube.com/watch?v=STOFYt-GJXk)
- [https://www.youtube.com/watch?v=sLLYwQhIEJE](https://www.youtube.com/watch?v=sLLYwQhIEJE)
