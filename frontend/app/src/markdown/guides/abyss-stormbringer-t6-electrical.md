...
- Average ISK/h (after filament costs) : 280 - 350 Million ISK
- Difficulty: Medium

| Pros | Cons |
| --- | --- |
| - Very easy tank management - Very easy cap management - Excels against large groups of enemies - Unaffected by weapon disruption | - Electricals are very popular which makes the filaments expensive and the loot cheap. - Very low single target DPS - Has guaranteed death scenarios due to time limit |
...
- Vorton Specialization does not affect the faction gun, so it is not necessary.
- If you plan on using the Stormbringer a lot, it's highly recommended to get all of the above skills to V.
...
Your main concern in every room is going to be maximising your DPS. This means picking optimal targets for your vorton more then anything.
...
- Kill Snarecasters first
- Aim for the blob
- Bonus points for baiting them into a Blue Cloud or Deviant Automata
...
Don't get complacent though. If you let them get on top of you too quickly they'll spread out and can take up to 5 mins to clear.
...
- Give up on loot
- Use Pyro IV
- Overheat prop 1-2 cycles
- Shoot any Plateforgers
- Overheat DPS and focus Overmind
- Orbit 500
- Keep the Overmind *away* from speed clouds
...
- Try to frag a couple of Anchoring Damaviks whilst the Vedmaks get in range
- Focus Vedmaks
- Finish Damaviks
...
- Look for a Deviant Automata Tower or Blue Cloud and burn for it before you get scrammed
- Focus Vedmaks
- Finish Damaviks
...
- Check the 'Type' column instead of the 'Name' column for Scylla Drifter...types.
- Clear Nullwarps
- Clear Entanglements
- Clear Nullcharge
- Clear the rest
...
**Details:**
 These guys like to clump together. We like. You'll probably find that by clearing the Nullwarps and Entanglements you'll kill off the rest of them anyway.
...
- **Don't stop moving**
- Orbit Deepwatchers at ~20km with prop on
- Focus the Deepwatchers
- Clear up anything that didn't die to bounces
...
The second is that these guys fire lots and lots of very slow moving missiles with very long flight times. Over time you'll start to see lots of little lights following you around and if you decide to stop for too long, those little lights will catch up to you and light you up. I have very quickly found myself in structure when thinking "I wonder how much damage those missiles actually do". All those little missiles that stacked up will hit you in rapid succession for a very large collective alpha.

Don't. Stop. Moving.

#### Karybdis "Karen" Tyrannos

**Danger Level:** High

**Quick Tips:**

- Burn towards Karen at ~45°
- Overheat DPS
- Clear any Spearfisher/Nullwarp
- If still not in range of Karen, clear any Entanglers/Entanglments
- Focus DPS Karen and orbit 500
- Drive Karen back to gate once Sleepers/Drifters die to bounces
...
- If this is not your first room, make the most of your invulnerability timer to close range.
- Clear Marshals
- Clear rest
...
- If this is not your first room, make the most of your invulnerability timer to close range.
- If this is your first room, heat prop 1-2 cycles to close range
- TURN OFF PROP
- Get within 10km of Marshals and clear them
- Clear Thunderchilds
- Prop back on
- Clear rest

**Details:**
 The combined DPS/Alpha from Marshals and Thunderchilds in this room can get very spicy with prop on, especially if you're unlucky with wrecking shots. With prop off however, the dps becomes manageable. Get on top of them ASAP and turn off prop.
