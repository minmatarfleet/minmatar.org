...
FEATURE_DEFINITIONS: dict[str, FeatureDefinition] = {
    ...
    "campaigns.view": FeatureDefinition(
        code="campaigns.view",
        label="View campaigns",
        scope=FeatureScope.AFFILIATION,
        description="See Faction Warfare campaigns and their standings.",
        legacy_permission="campaigns.view_campaign",
        default_affiliation_names=_aff("Alliance", "Militia", "Associate"),
    ),
    "campaigns.enlist": FeatureDefinition(
        code="campaigns.enlist",
        label="Enlist in campaigns",
        scope=FeatureScope.AFFILIATION,
        description="Enlist in a campaign and have your activity counted.",
        legacy_permission="campaigns.add_campaignenlistment",
        default_affiliation_names=_aff("Alliance"),
    ),
    "campaigns.form_gang": FeatureDefinition(
        code="campaigns.form_gang",
        label="Form campaign gangs",
        scope=FeatureScope.AFFILIATION,
        description="Start a tracked gang from a campaign page.",
        legacy_permission="campaigns.add_campaignevent",
        default_affiliation_names=_aff("Alliance"),
    ),
    "campaigns.create": FeatureDefinition(
        code="campaigns.create",
        label="Create campaigns",
        scope=FeatureScope.AUTH_GROUP,
        description="Create and schedule Faction Warfare campaigns.",
        legacy_permission="campaigns.add_campaign",
    ),
    "campaigns.manage": FeatureDefinition(
        code="campaigns.manage",
        label="Manage campaigns",
        scope=FeatureScope.STAFF,
        description="Edit any campaign, accept weekly plans, set orders.",
        legacy_permission="campaigns.change_campaign",
        staff_permission="campaigns.change_campaign",
    ),
}
