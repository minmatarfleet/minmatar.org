-- Subcapital production tribe (Industry order tool): roster users — primary character,
-- committed vs delivered units and ISK (qty × per-unit targets; 30d for delivered).
-- Tribe: slug `industry`, group `Subcapital Production`. Orders tagged via industry_industryorder_tribe_groups.
--
