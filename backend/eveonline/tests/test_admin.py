...
class AdminAppListGroupingTestCase(TestCase):
    ...
    def test_supply_shows_industry_orders_hub_only(self):
        ...
        self.assertIn("loyalty points", supply_names)
        self.assertNotIn("industryorder", supply_objects)
        self.assertNotIn("industryloyaltypoint", supply_objects)
        self.assertNotIn("industryloyaltypointmarketorder", supply_objects)
